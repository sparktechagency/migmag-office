                        ...
                        <nav className="hidden lg:flex flex-row items-center gap-x-12">
                            <ul className="flex items-center gap-x-8 text-lg">
                                <li className="relative group">
                                    ...
                                    <span className={`text-black cursor-pointer `}>Vocals</span>
                    ...
                    <div
                                ...
                                <Link href="/">
                                    <svg width="174" height="22" viewBox="0 0 174 22" fill="none"
                                        ...
                                        <g clip-path="url(#clip0_27_23)">
                                            <path
                                                d="M76.7524 9.06705H68.8924V21.7686H64.7478V9.06705H56.8997V5.57196H76.7524V9.06705Z"
                                                fill="white" />
                                            <path
                        ...
                        <ul className="flex flex-col p-4 gap-4">
                            <li>
                                <Link
                                    href="/vocals"
                                    className={` ${pathname === "/browse-vocal" ? "btnTextColor  " : "text-white"}`}
                                >
                                    Vocals
                                </Link>
                            </li>
                            ...
                            <li><Link
                                className={` ${pathname === "/artist-library" ? "btnTextColor  " : "text-white"}`}
                                href="/artist-library">Artists</Link></li>
                            <li><Link className={` ${pathname === "/hire" ? "btnTextColor  " : "text-white"}`}
