                ...
                <div className={` py-7 `}>
                    <div
                        ...
                        <nav className="hidden lg:flex flex-row items-center gap-x-12">
                            <ul className="flex items-center gap-x-8 text-lg">
                                ...
                                <li>
                                    <Link className={`${pathname === "/artist-list" ? " btnTextColor " : "text-white"}`}
                                        href="/artist-list"> Artists </Link>
                                </li>
                                <li>
                                    <Link className="text-white" href="/hire">Hire</Link></li>
                            </ul>
                    ...
                    <div
                        ...
                        <ul className="flex flex-col p-4 gap-4">
                            <li><Link className={`${pathname === "/vocals" ? " btnTextColor " : 'text-black'}`}
                                href="/vocals">Vocals</Link></li>
                            <li>
                                <Link className={`${pathname === "/cover-vocals" ? " btnTextColor " : 'text-black'}`}
                                    href="/cover-vocals">Cover Vocals</Link>
                            </li>
                            ...
                            <li><Link className={`${pathname === "/artist-list" ? "text-[#FFBD00]" : 'text-black'}`}

                                href="/artist-list">Artists</Link></li>
                            <li><Link className={`${pathname === "/hire" ? " btnTextColor " : 'text-black'}`}
                                href="/hire">Hire</Link></li>
                            <li><Link className={`${pathname === "/cart" ? " btnTextColor btnColor " : 'text-black'}`}
                                href="/cart">Cart ({
